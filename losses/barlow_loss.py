...
class Barlow(torch.nn.Module):
    ...
    Adapt from https://github.com/lightly-ai/lightly/blob/9bda4ee1b8bd756da9e4430197b26077861893ed/lightly/loss/barlow_twins_loss.py
