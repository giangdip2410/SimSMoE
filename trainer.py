    ...
    if not eval_only:
        ...
        if load_balance > 0:
            ...
            for name, m in model.named_modules():
                if isinstance(m, CustomNaiveGate_Balance_SMoE) or (isinstance(m, CustomNaiveGate_Balance_XMoE) or isinstance(m, CustomNaiveGate_Balance_StableMoE)):
